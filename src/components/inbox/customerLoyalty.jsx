            ...
            <section className='py-24 md:py-16'>
                <div className='w-full my-0 py-0 px-8 lg:px-6 md:px-4'>
                    <div className='grid grid-cols-11 sm:flex sm:flex-col sm:items-center sm:justify-center sm:gap-8'>
                        <div className='col-span-6 items-start sm:items-center px-24 md:px-14 justify-start sm:justify-center flex flex-col gap-4 md:gap-2'>
                            ...
                            <Link href="/signup" className='mt-9 bg-red-500 md:mt-6 flex justify-center text-xl md:text-base font-semibold py-3 px-8 sm:px-32 rounded-md border-2 border-solid text-black hover:text-white'>Try Free</Link>
                        </div>
