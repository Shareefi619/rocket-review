...
const Feedback = () => {
    return (
        <section className='py-24 bg-blue-400 md:py-16 xxs:py-10'>
            <div className='w-full my-0 py-0 px-8 md:px-4 sm:px-3 xxs:px-0'>
                <div className='grid grid-cols-11 sm:flex sm:flex-col sm:items-center sm:justify-center'>
                    ...
                    <div className='col-span-6 items-start px-36 justify-start sm:items-center sm:justify-center flex flex-col gap-4 md:px-6 xxs:px-2 md:gap-2'>
                        <h2 className='text-5xl font-bold text-left mb-3 text-black mx-auto lg:text-3xl md:text-2xl sm:text-2xl xxs:text-center sm:font-extrabold'>Improve your Reputation with Private Feedback</h2>
