            ...
            <div className='max-w-[1170px] w-full my-0 mx-auto box-border flex flex-col'>
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <div className="border-2 border-gray-200 dark:border-gray-700 mt-10 mr-[180px] md:mr-[50px]">
                        <ul
                            className="flex flex-wrap text-2xl md:text-base font-bold text-center"
                            id="default-tab"
                    ...
                    <div id="default-tab-content" className='w-[900px] md:w-[700px]'>
                        <div
                        ...
                        >
                            <div className='w-[900px] md:w-[700px] mb-12 flex items-center justify-center gap-4 py-16 px-6'>
                        ...
                        >
                            <div className='flex flex-col items-center justify-center gap-4 md:gap-2 w-[900px] md:w-[700px] my-6'>
                                <div className='flex bg-white m-5 p-5 md:m-2 border-2 border-solid rounded-md mx-2' style={{ borderColor: "rgb(230, 230, 234)" }}>
                                    ...
                                    <div className='flex gap-2 items-end my-6 justify-end w-[500px]'>
