...
const VideoSection = () => {
    ...
    return (
        <div className='flex flex-col bg-blue-500/90 p-12 py-10 xl:p-6 xl:py-8 xs:p-0 xs:py-4 xxs:py-0'>
            <h1 className='flex flex-col items-center justify-start xs:justify-center text-white text-6xl font-bold mb-4 pt-20 xxs:pt-14 xl:text-5xl md:text-3xl xs:text-center xl:mb-2'>Generate reviews on auto-pilot</h1>
                    ...
                    <div className='flex items-start justify-start'>
                        ...
                        <div>
                            ...
                            <div className='flex gap-4 mt-14 xl:mt-8'>
                                <p className='text-7xl font-extrabold xl:text-5xl sm:text-3xl text-white'><strong>25%</strong> </p>
                                <p className='text-white text-lg xl:text-base sm:text-sm'>more influence of reviews on <br />conversions than in 2019</p>
                            </div>
                            <div className='flex mt-8 px-4'>
                                <Link href="/generate-reviews" className='border-[3px] hover:border-black rounded-lg py-3 px-10 text-2xl xl:py-2 xl:px-7 xl:text-xl font-medium text-white hover:text-black bg-red-600'>Get more conversions &#x2192;</Link>
                            </div>
                        </div>
                    </div>
                </div>
