...
const Pricing = ({ title, imgSrc, imgPosition, person }) => {
    ...
    return (
        <>
            <section className={`pb-12  px-24 md:px-16 ${router === "/pricing" ? "bg-black/90" : "bg-blue-400 "}`}>

                <div className='grid grid-cols-12 py-12 col-start-4 mb-4'>
                    <div className='flex items-center justify-center gap-6 col-span-4 col-start-5 xl:col-span-6 lg:col-span-8 lg:col-start-3 xl:col-start-4 bg-red-500/90 p-12  xl:p-8 rounded-lg'>
                        <p className='text-xl font-medium text-white'>Billed monthly</p>
                        ...
                        <p className='text-xl font-medium text-white'>Billed yearly</p>
                        <div className='absolute right-[33rem] mt-24 xl:right-72 lg:right-52 md:right-32'>
                            <p className='bg-white  transform-tag px-5 py-3 rounded-lg text-black text-base font-bold '>Save up to 20%</p>
                        </div>
                    </div>
                </div>
                <div>
                    <div className='container'>
                        <div className='flex items-center justify-center'>
                            <div className='w-1/2 bg-white rounded-lg flex flex-col p-10 border border-gray-300 md:p-2 md:w-3/4 md:py-12'>
                                <h1 className='flex justify-center text-4xl text-black font-bold py-6'>Large</h1>
                                <p className='flex justify-center text-blue-600 text-base bg-blue-50 mx-16 py-2 rounded-lg font-bold lg:mx-6 lg:px-4 md:px-2 md:mx-24'>IDEAL FOR LARGER TEAMS</p>
                                <div className='flex justify-center py-12'>
                                    <p className='text-black/90 text-6xl font-bold'>${toggle ? '79' : '99'}</p>
                                    <p className='text-black/75 text-xl font-bold'>/month</p>
                                </div>
                                <p className='flex justify-center text-lg text-black/75 mb-6'>{toggle ? '$950 billed annually' : 'Billed monthly'}</p>
                                <Link href='/signup' className="flex justify-center text-black text-xl font-bold bg-red-500 py-3 px-28 md:px-12 md:mx-24 hover:text-white rounded-lg" >Try Free</Link>
                                ...
                                <ul className='flex flex-col mt-5 space-y-2 md:mx-24'>
