    ...
    return (
        <>
            <section className='flex flex-col items-center justify-center p-12 lg:p-2 md:p-1 lg:pb-16 md:pb-14 bg-black/90'>
                <div className='grid grid-cols-12 p-8 md:p-4 mt-16 xl:mt-8 lg:mt-6'>
                    <div className='col-span-6'>
                        <div className='ml-4'>
                            <Image src={BannerArrow2} width={80} alt='arrow2' />
                        </div>
                        <div className='flex items-center justify-center my-4 '>
                            <h1 className=' text-white w-11/12 text-7xl font-extrabold xl:w-full xl:text-5xl lg:text-4xl md:text-3xl'>{title}</h1>
                        </div>
                        <div className='flex items-center justify-center mb-6'>
                            <p className='text-2xl w-11/12 text-white xl:w-full xl:text-xl lg:text-lg md:text-base my-4'>{subtitle}</p>
                        </div>
                        ...
                        <div className='flex items-start justify-start mt-4 ml-52 xl:ml-40 md:ml-28'>
                            <p className='text-white text-lg md:text-base'>No credit card required</p>
                        </div>
                        <div className="absolute left-[50%] top-[85%] xl:top-[70%]">
                            <Image src={BannerArrow1} width={120} alt='arrow1' />
                        </div>

                    </div>
                    <div className='col-span-6 flex items-center justify-center xl:ml-36'>
                       <Image src={heroImg} className='w-[600px] xl:w-[400px]'/>
                    </div>
                </div>
                <div className='w-full flex items-center justify-center bg-white px-4 py-2 mt-16 mx-36 rounded-lg'>
