...
const GenericSocialSection = ({
  ...
  return (
    <div className='flex flex-col bg-blue-400 p-12 md:p-8 py-24 xs:p-0 xs:py-12'>
      <h1 className='flex flex-col items-center justify-start text-white text-5xl md:text-3xl xs:text-center font-bold mb-4 sm:mb-0 xxs:mb-4'>{title}</h1>
        ...
        <div className='col-span-6'>
          <div className='flex items-start justify-start'>
            ...
            <div>
              ...
              <p className='text-white font-serif font-normal text-3xl my-10 xl:text-2xl md:text-xl xl:my-7 sm:my-2'>{reviewText}</p>
              ...
              <div className='flex gap-4 mt-14 xl:mt-10'>
                <p className='text-7xl font-extrabold xl:text-5xl text-white'>
                  <strong>{influencePercentage}</strong>{' '}
                </p>
                <p className='text-white text-lg xl:text-base'>
                 {altText}
                </p>
              </div>
              <div className='flex mt-8 px-4 sm:px-0'>
                <Link href={findOutMoreLink} className='border-[3px] hover:border-black rounded-lg py-5 px-10 text-2xl font-bold bg-red-600 xl:py-2 xl:px-8 xl:text-xl text-white hover:text-black'>
