...
const HeroBanner = ({ title, titleRemain, subtitle }) => {
    ...
    return (
        <>
            <div className='w-full flex flex-col items-center justify-center bg-black/90 p-10 2xl:p-2 xl:p-12 md:p-4 md:pb-12'>
                ...
                <div className='flex items-center justify-center gap-4  '>
                    ...
                    <Link href="/signup" className='border-solid border-2 border-red-500 hover:border-white text-white hover:text-red-500 py-3 px-10 text-xl xl:py-2 xl:px-7 xl:text-lg lg:text-base md:text-sm font-semibold rounded-lg'>Contact Sales</Link>
                </div>
                ...
                <div className='flex items-center justify-center w-[1300px] xl:w-[700px] '>
                    <Image src={WebPage} alt='webpage' />
                </div>

                <div className='flex items-center justify-center bg-white px-4 py-2 mt-16 mx-36 rounded-lg xl:w-full xl:mx-24 xl:px-4 xl:py-6 lg:mx-8 lg:px-8 lg:py-5'>
                    <Image src={comma} alt='comma' className='relative w-40 xl:w-24 md:w-20 bottom-10 right-4' />
                    <div>
                        <p className='text-2xl font-bold right-9 bottom-8 xl:text-lg md:text-base'>"We have generated over 2,000 reviews for our clients using Reviewshake."</p>
                        <div className='flex items-start justify-start mt-4'>
                            ...
                            <div className='flex gap-4 items-end justify-end ml-[40rem] xl:ml-[25rem] lg:ml-[20rem] md:ml-[10rem]'>
                    ...
                    <div className="flex items-center justify-center mt-24 mb-6">
                        <div className="text-center w-full">
                            <div className="flex items-center justify-center">
                                ...
                                <div className="mx-4 text-white text-base uppercase font-semibold">1000+ COMPANIES TRUST REVIEWSHAKE</div>
                                <div className="flex-1 border-t border-white"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex justify-center items-center my-2'>
                        {brandLogo.map((img, index) => (
                            <Image
                                ...
                                alt="brand logo"
                                className="mx-2 rounded-md xl:mx-1 xl:w-52 lg:mx-auto lg:w-44 md:w-36"
                            />
                        ))}
                    </div>
                </div>
