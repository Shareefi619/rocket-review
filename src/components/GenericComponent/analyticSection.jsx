            ...
            <div className='flex items-center justify-center bg-white p-24 xl:p-12 lg:p-10 md:p-7'>
                <div className='grid grid-cols-12'>
                    <div className='col-span-6 p-28 xl:p-14 lg:p-10 md:p-7'>
                        <h1 className='text-4xl text-black font-extrabold xl:text-3xl lg:text-2xl md:text-xl'>{title}</h1>
                        <p className='text-3xl text-black/75 font-normal py-6 xl:text-2xl lg:text-xl md:text-lg'>{subtitle}</p>
                    </div>
