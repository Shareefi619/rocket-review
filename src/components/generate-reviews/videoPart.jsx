...
const VideoPart = () => {
    ...
    return (
        <div className='flex flex-col bg-white p-12 py-6 sm:p-4'>
            <div className='grid items-start justify-start grid-cols-12 p-24 xl:p-12 md:p-8 sm:p-8 sm:flex sm:flex-col sm:text-center'>
                <div className='col-span-6'>
                    <div className='flex flex-col items-start justify-start sm:items-center sm:justify-center p-16 mt-28 xl:p-10 xl:mt-20 md:p-6 md:mt-0'>
